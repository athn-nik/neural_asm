...
from modules.datasets import PairDataset, CharDataset
...
def load_pretrained_model(name):
    model_path = os.path.join(BASE_PATH, "trained",
                              "{}.model".format(name))
    model_conf_path = os.path.join(BASE_PATH, "trained",
                                   "{}.conf".format(name))
...
def load_pretrained_models(name):
    models_path = os.path.join(BASE_PATH, "trained")
